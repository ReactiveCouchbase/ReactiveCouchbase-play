...
object ApplicationBuild extends Build {
  ...
  lazy val plugin = Project(appName, base = file("plugin"))
    ...
    .settings(
      ...
      libraryDependencies += "org.reactivecouchbase" %% "reactivecouchbase-core" % "0.5-SNAPSHOT" cross CrossVersion.binary,
      libraryDependencies += "org.reactivecouchbase" %% "reactivecouchbase-es" % "0.5-SNAPSHOT" cross CrossVersion.binary,
      libraryDependencies += "com.typesafe.play" %% "play" % "2.3.10" % "provided" cross CrossVersion.binary,
      libraryDependencies += "com.typesafe.play" %% "play-cache" % "2.3.10" cross CrossVersion.binary,
